    ...
    <div class="row py-4">
        <div class="col-lg-3 col-md-6 mb-5">
            ...
            <div class="d-flex justify-content-start">
                <a class="btn btn-lg btn-secondary btn-lg-square mr-2" href="wwww.freewebsitecode.com"><i
                        class="fab fa-twitter"></i></a>
                <a class="btn btn-lg btn-secondary btn-lg-square mr-2"
                    href="https://www.facebook.com/FreeWebsiteCode/"><i class="fab fa-facebook-f"></i></a>
                <a class="btn btn-lg btn-secondary btn-lg-square mr-2" href="wwww.freewebsitecode.com"><i
                        class="fab fa-linkedin-in"></i></a>
                <a class="btn btn-lg btn-secondary btn-lg-square mr-2" href="wwww.freewebsitecode.com"><i
                        class="fab fa-instagram"></i></a>
                <a class="btn btn-lg btn-secondary btn-lg-square"
                    href="https://www.youtube.com/channel/UC9HlQRmKgG3jeVD_fBxj1Pw/videos"><i
...
<div class="container-fluid py-4 px-sm-3 px-md-5" style="background: #111111">
    <p class="m-0 text-center">
        &copy; <a href="#">KNEWS</a>. All Rights Reserved. Design by
        <a href="https://freewebsitecode.com" target="_blank">Freewebsitecode</a><br />
    </p>
</div>
<!-- Footer End -->
