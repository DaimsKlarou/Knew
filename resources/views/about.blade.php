@extends('layout')
@section('titre', "Ici c'est la page About")
@include('menu')
 @section('paragraph')
     <p>
         ...
         informatique, sans que son contenu n'en soit modifié. Il a été popularisé dans les années 1960 grâce à la vente de feuilles Letraset contenant des passages du Lorem Ipsum, et, plus récemment, par son inclusion dans des applications de mise en page de texte, comme Aldus PageMaker.
     </p>
 @endsection