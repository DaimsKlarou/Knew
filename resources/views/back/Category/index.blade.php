                            ...
                            <tbody>
                                @foreach ($categories as $category)
                                    <tr>
                                        ...
                                        <td>{{$category->name}} </td>
                                        <td>{{Str::before($category->description, ',') . '...'}} </td>
                                        <td>
                                            <span class="badge badge-pill bg-success inv-badge">
                                                {{$category->isActive == true ? 'Actived' : 'Desactived'}}
                                            </span>
                                        </td>
                                        <td class="text-right">
                                    ...
                                    <div class="modal-content">
                                        <div class="modal-body text-center">
                                            ...
                                            <div class="m-t-20">
                                                ...
                                                <form @if(isset($category)) action="{{route('category.destroy', $category_delete)}}" @endif method="POST">
                                                    @csrf
                                                    @method('delete')
