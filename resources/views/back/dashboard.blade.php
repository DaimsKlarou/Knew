...
@section('content')
    <div class="row">
        <div class="col-sm-12 mt-5">
            <h3 class="page-title mt-3">Hello, Bonjour {{ $name }} </h3>
            <ul class="breadcrumb">
            ...
            <div class="card board1 fill">
                <div class="card-body">
                    <div class="dash-widget-header">
                        <div>
                            <h3 class="card_widget_header"> {{ $authors->count() }} </h3>
        ...
        <div class="col-xl-3 col-sm-6 col-12">
            <div class="card board1 fill">
                <div class="card-body">
                    <div class="dash-widget-header">
                        <div>
                            <h3 class="card_widget_header"> {{ $categories->count() }} </h3>
        ...
        <div class="col-xl-3 col-sm-6 col-12">
            <div class="card board1 fill">
                <div class="card-body">
                    <div class="dash-widget-header">
                        <div>
                            <h3 class="card_widget_header"> {{ $articles->count() }} </h3>
        ...
        <div class="col-md-12 d-flex">
            <div class="card card-table flex-fill">
                <div class="card-header">
                    ...
                    <a href="{{ route('article.index') }}" type="button" class="btn btn-primary float-right veiwbutton">
                        Voir tous
                    </a>
                </div>
                <div class="card-body">
                        ...
                        <table class="table table-hover table-center">
                            ...
                            <tbody>
                                @foreach ($articles as $article)
                                    <tr>
                                        <td class="text-nowrap"> #ART-000{{ $article->id }} </td>
                                        <td class="text-nowrap"> <img src="{{ $article->imageUrl() }}"
                                                alt="image article" width="100" height="100"> </td>
                                        <td class="text-nowrap"> {{ $article->title }} </td>
                                        <td class="text-nowrap"> {{ $article->category->name }} </td>
                                        <td class="text-nowrap"> {{ $article->author->name }} </td>
                                        <td class="text-center">
                                            @if ($article->isActive)
                                                <span class="badge badge-pill bg-success inv-badge">PUBLIE</span>
                                            @else
                                                <span class="badge badge-pill bg-danger inv-badge">NON PUBLIE</span>
                                            @endif
                                        </td>
                                    </tr>
                                @endforeach
